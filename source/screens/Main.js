                ...
                <TouchableOpacity onPress={() => this.elementClicked(item)}>
                  <View style={styles.flatview}>
                    <Image style={styles.itemImage}
                      source={{ uri: "https://www.zb.uzh.ch/Medien/spezialsammlungen/Turicensia/Ausstellungen/HirsebreiHueppenHosechnoepf/Quiz-Bilder/frage_14_froschauerbrunnen.jpg" }}>
                    </Image>
